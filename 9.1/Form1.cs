...
namespace _9._1
{
    public partial class Form1 : Form
    {
         ...
         * | Для работы через консоль в параметрах командной (Свойства проекта - Отладка) строки указать
         * --input-file='Путь к входным данным' --output-file='Путь к выходным данным'
